...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog/static'),   # point to your app static folder
]

# Collectstatic ke liye (optional)
...
ALLOWED_HOSTS = ['my-django-project-3-gah0.onrender.com', 'localhost', '127.0.0.1']
